...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <![endif]-->
    <nav class="navbar navbar-default navbar-fixed-top top-header" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">
           <img src="<?php echo base_url();?>appclient/img/hjm2.png" class="hidden-xs"alt="" style="height: 35px; position: relative; bottom: 7px;">
           <img src="<?php echo base_url();?>appclient/img/hjm2.png" class="visible-xs"alt="" style="height: 25px;">
          </a>
        </div>
